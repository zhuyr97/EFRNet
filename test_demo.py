...
def select_model(args, device):
    ...
    if model_id == 27:
        ...
        from models.team27_EFRNet import EFRNet
        name, data_range = f"{model_id:02}_EFRNet_baseline", 1.0
        model_path = os.path.join('model_zoo', 'team27_EFRNet.pth')
        model = EFRNet()
...
def main(args):
    ...
    utils_logger.logger_info("NTIRE2023-EfficientSR", log_path=args.log_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="path to your data dir", type=str)
    parser.add_argument("--save_dir", default="path to your save dir", type=str)
    parser.add_argument("--log_path", default="path to your save log.log", type=str)
